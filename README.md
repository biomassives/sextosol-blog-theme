...
# Sexto Sol Center Theme

This theme is designed from the free VuePress Bootstrap Blogging Theme. It features: multi author, search, categories, newsletter, Disqus, RSS, sitemap, TOC, Prism, 100% Github pages compatible, ready for automatic deployment.
