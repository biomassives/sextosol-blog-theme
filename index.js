...
module.exports = themeConfig => {
  ...
  themeConfig = Object.assign(themeConfig, {
    ...
    nav: themeConfig.nav || [
      ...
      {
        text: 'Pendants',
        link: 'https://slideshows.maryholtz.art/pendants.html',
      },
      {
        text: 'Photos',
        link: 'https://slideshows.maryholtz.art/photos.html',
      },
      {
        text: 'Paintings',
        link: 'https://slideshows.maryholtz.art/',
      },

      {
        text: 'Gallery',
        link: 'https://mary-holtz-art.netlify.app/',
      },
      {
        text: 'Contact',
        link: '/tag/',
